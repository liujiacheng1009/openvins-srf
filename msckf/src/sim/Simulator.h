 ...
 *
 * Given a trajectory this will generate a SE(3) @ref core::BsplineSE3 for that trajectory.
...
public:
   ...
   */
  bool get_next_imu(double &time_imu, Eigen::Matrix<number_t, 3, 1> &wm, Eigen::Matrix<number_t, 3, 1> &am);
...
protected:
  ...
  std::shared_ptr<core::BsplineSE3> spline;
