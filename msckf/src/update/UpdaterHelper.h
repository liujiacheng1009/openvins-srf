...
public:
  ...
  struct UpdaterHelperFeature {
    ...
    type::LandmarkRepresentation::Representation feat_representation;
   ...
   */
  static void get_feature_jacobian_representation(std::shared_ptr<State> state, UpdaterHelperFeature &feature, MatrixX &H_f,
                                                  std::vector<MatrixX> &H_x, std::vector<std::shared_ptr<type::Type>> &x_order);
   ...
   * @param[out] x_order Extra variables our extra Jacobian has (for example anchored pose)
   */
  static void get_feature_jacobian_full(std::shared_ptr<State> state, UpdaterHelperFeature &feature, MatrixX &H_f,
                                        MatrixX &H_x, VectorX &res, std::vector<std::shared_ptr<type::Type>> &x_order);
   ...
   */
  static void nullspace_project_inplace(MatrixX &H_f, MatrixX &H_x, VectorX &res);
   ...
   * @param res Measurement residual
   */
  static void measurement_compress_inplace(MatrixX &H_x, VectorX &res);
};
