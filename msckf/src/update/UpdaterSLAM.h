...
public:
   ...
   */
  UpdaterSLAM(UpdaterOptions &options_slam, core::FeatureInitializerOptions &feat_init_options);
   ...
   */
  void update(std::shared_ptr<State> state, std::vector<std::shared_ptr<core::Feature>> &feature_vec);
   ...
   * @param feature_vec Features that can be used for update
   */
  void delayed_init(std::shared_ptr<State> state, std::vector<std::shared_ptr<core::Feature>> &feature_vec);
...
protected:
   ...
   */
  void perform_anchor_change(std::shared_ptr<State> state, std::shared_ptr<type::Landmark> landmark, double new_anchor_timestamp,
                             size_t new_cam_id);
  ...
  std::shared_ptr<core::FeatureInitializer> initializer_feat;
