...
public:
   ...
   */
  bool fast_state_propagate(std::shared_ptr<State> state, double timestamp, Eigen::Matrix<number_t, 13, 1> &state_plus,
   ...
   */
  static std::vector<core::ImuData> select_imu_readings(const std::vector<core::ImuData> &imu_data, double time0, double time1,
                                                           bool warn = true);
  ...
  static core::ImuData interpolate_data(const core::ImuData &imu_1, const core::ImuData &imu_2, double timestamp) {
    ...
    number_t lambda = static_cast<number_t>((timestamp - imu_1.timestamp) / (imu_2.timestamp - imu_1.timestamp));
   ...
   */
  static MatrixX compute_H_Dw(std::shared_ptr<State> state, const Eigen::Matrix<number_t, 3, 1> &w_uncorrected);
   ...
   */
  static MatrixX compute_H_Da(std::shared_ptr<State> state, const Eigen::Matrix<number_t,3,1> &a_uncorrected);
   ...
   */
  static MatrixX compute_H_Tg(std::shared_ptr<State> state, const Eigen::Matrix<number_t, 3, 1> &a_inI);
...
protected:
   ...
   */
  void predict_and_compute(std::shared_ptr<State> state, const core::ImuData &data_minus, const core::ImuData &data_plus,
   ...
   */
  void predict_mean_discrete(std::shared_ptr<State> state, number_t dt, const Eigen::Matrix<number_t, 3, 1> &w_hat, const Eigen::Matrix<number_t, 3, 1> &a_hat,
   ...
   * @param new_p The resulting new position after integration
   */
  void predict_mean_rk4(std::shared_ptr<State> state, number_t dt, const Eigen::Matrix<number_t, 3, 1> &w_hat1, const Eigen::Matrix<number_t, 3, 1> &a_hat1,
                        const Eigen::Matrix<number_t, 3, 1> &w_hat2, const Eigen::Matrix<number_t, 3, 1> &a_hat2, Eigen::Matrix<number_t, 4, 1> &new_q, Eigen::Matrix<number_t, 3, 1> &new_v,
                        Eigen::Matrix<number_t, 3, 1> &new_p);
   ...
   */
  void compute_Xi_sum(std::shared_ptr<State> state, double dt, const Eigen::Matrix<number_t, 3, 1> &w_hat, const Eigen::Matrix<number_t, 3, 1> &a_hat,
   ...
   */
  void predict_mean_analytic(std::shared_ptr<State> state, number_t dt, const Eigen::Matrix<number_t, 3, 1> &w_hat, const Eigen::Matrix<number_t, 3, 1> &a_hat,
                             Eigen::Matrix<number_t, 4, 1> &new_q, Eigen::Matrix<number_t, 3, 1> &new_v, Eigen::Matrix<number_t, 3, 1> &new_p, Eigen::Matrix<number_t, 3, 18> &Xi_sum);
   ...
   */
  void compute_F_and_G_analytic(std::shared_ptr<State> state, number_t dt, const Eigen::Matrix<number_t, 3, 1> &w_hat, const Eigen::Matrix<number_t, 3, 1> &a_hat,
                                const Eigen::Matrix<number_t, 3, 1> &w_uncorrected, const Eigen::Matrix<number_t, 3, 1> &a_uncorrected, const Eigen::Matrix<number_t, 4, 1> &new_q,
                                const Eigen::Matrix<number_t, 3, 1> &new_v, const Eigen::Matrix<number_t, 3, 1> &new_p, const Eigen::Matrix<number_t, 3, 18> &Xi_sum,
                                MatrixX &F, MatrixX &G);
   ...
   * @param G Noise Jacobian
   */
  void compute_F_and_G_discrete(std::shared_ptr<State> state, number_t dt, const Eigen::Matrix<number_t, 3, 1> &w_hat, const Eigen::Matrix<number_t, 3, 1> &a_hat,
                                const Eigen::Matrix<number_t, 3, 1> &w_uncorrected, const Eigen::Matrix<number_t, 3, 1> &a_uncorrected, const Eigen::Matrix<number_t, 4, 1> &new_q,
                                const Eigen::Matrix<number_t, 3, 1> &new_v, const Eigen::Matrix<number_t, 3, 1> &new_p, MatrixX &F, MatrixX &G);
  ...
  MatrixX cache_state_est;
  MatrixX cache_state_covariance;
  double cache_t_off;
};
