...
![SR-EKF VIO 整体流程](assets/01-sr-vio-flow.png)
...
![IMU Propagation](assets/02-imu-prop.png)
...
![State Augmentation](assets/03-state-aug.png)
...
![视觉特征分类](assets/04-feat-class.png)
...
![Householder](assets/07-householder.png)
...
![Anchor Change](assets/09-anchor-change.png)
...
![Delay Init](assets/10-delay-init.png)
