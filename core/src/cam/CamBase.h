...
public:
   ...
   */
  virtual void set_value(const MatrixX &calib) {
   ...
   */
  virtual void compute_distort_jacobian(const Eigen::Vector2d &uv_norm, MatrixX &H_dz_dzn, MatrixX &H_dz_dzeta) = 0;

  /// Gets the complete intrinsic vector
  MatrixX get_value() { return camera_values; }
