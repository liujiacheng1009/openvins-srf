 ...
 * \f}
 *
 * In analogy to the previous radial distortion (see @ref core::CamRadtan) case, the following Jacobian for these
...
public:
   ...
   */
  void compute_distort_jacobian(const Eigen::Vector2d &uv_norm, MatrixX &H_dz_dzn, MatrixX &H_dz_dzeta) override {
