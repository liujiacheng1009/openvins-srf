 ...
 *
 * - 3d feature initialization (see @ref core::FeatureInitializer)
 * - SE(3) b-spline (see @ref core::BsplineSE3)
 * - KLT, descriptor, and simulation feature trackers
 * - Groundtruth dataset reader (see @ref core::DatasetReader)
 * - Quaternion and other manifold math operations
 * - Generic type system and their implementations (see @ref type namespace)
 ...
 * If you are looking for the different types please take a look at the type namespace for the ones we have.
 *
 */
namespace core {}
 ...
 * A type with non-trivial error states is the @ref type::JPLQuat which has equivalent quaterion and SO(3) error.
