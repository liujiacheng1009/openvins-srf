 ...
 * @code{.cpp}
 * core::Printer::setPrintLevel("WARNING");
 * core::Printer::setPrintLevel(core::Printer::PrintLevel::WARNING);
 * @endcode
 */
class Printer {
public:
 ...
 */
#define PRINT_ALL(x...) core::Printer::debugPrint(core::Printer::PrintLevel::ALL, __FILE__, TOSTRING(__LINE__), x);
#define PRINT_DEBUG(x...) core::Printer::debugPrint(core::Printer::PrintLevel::DEBUG, __FILE__, TOSTRING(__LINE__), x);
#define PRINT_INFO(x...) core::Printer::debugPrint(core::Printer::PrintLevel::INFO, __FILE__, TOSTRING(__LINE__), x);
#define PRINT_WARNING(x...) core::Printer::debugPrint(core::Printer::PrintLevel::WARNING, __FILE__, TOSTRING(__LINE__), x);
#define PRINT_ERROR(x...) core::Printer::debugPrint(core::Printer::PrintLevel::ERROR, __FILE__, TOSTRING(__LINE__), x);
