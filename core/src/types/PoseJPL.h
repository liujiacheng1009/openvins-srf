...
public:
  PoseJPL() : Type(6) {
    ...
    Eigen::Matrix<number_t, 7, 1> pose0;
    pose0.setZero();
    pose0(3) = 1.0;
  ...
  void update(const VectorX &dx) override {
    ...
    Eigen::Matrix<number_t, 7, 1> newX = _value;
  ...
  /// Rotation access
  Eigen::Matrix<number_t, 3, 3> Rot() const { return _q->Rot(); }

  /// FEJ Rotation access
  Eigen::Matrix<number_t, 3, 3> Rot_fej() const { return _q->Rot_fej(); }

  /// Rotation access as quaternion
  Eigen::Matrix<number_t, 4, 1> quat() const { return _q->value(); }

  /// FEJ Rotation access as quaternion
  Eigen::Matrix<number_t, 4, 1> quat_fej() const { return _q->fej(); }

  /// Position access
  Eigen::Matrix<number_t, 3, 1> pos() const { return _p->value(); }

  // FEJ position access
  Eigen::Matrix<number_t, 3, 1> pos_fej() const { return _p->fej(); }
