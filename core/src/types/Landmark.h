...
public:
   ...
   */
  Eigen::Matrix<number_t, 3, 1> get_xyz(bool getfej) const;
   ...
   */
  void set_from_xyz(Eigen::Matrix<number_t, 3, 1> p_FinG, bool isfej);
};
} // namespace type
