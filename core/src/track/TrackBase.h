...
public:
   ...
   */
  TrackBase(std::unordered_map<size_t, std::shared_ptr<CamBase>> cameras, int numfeats, bool stereo,
...
protected:
  ...
  // 当前帧是否是关键帧, 仅用于输出到mapping模块
  bool is_curr_keyframe{true};

  double last_keyframe_ts{-1.};
