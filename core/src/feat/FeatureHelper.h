...
public:
   ...
   */
  static void compute_disparity(std::shared_ptr<core::FeatureDatabase> db, double time0, double time1, double &disp_mean,
   ...
   */
  static void compute_disparity(std::shared_ptr<core::FeatureDatabase> db, double &disp_mean, double &disp_var, int &total_feats,
