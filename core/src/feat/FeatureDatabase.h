...
public:
  ...
  bool determine_keyframe(std::vector<size_t> ids, size_t cam_id, double last_kf_timestamp);

  std::pair<int, double> tracking_info_from_lastkf(size_t cam_id, double curr_frm_timestamp, double last_kf_timestamp);
